...
function ContactPage() {
  const [isCreateGroupOpenModal, setIsCreateGroupOpenModal] = useState(false);
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between mb-6">
        ...
        <Button onClick={() => setIsCreateGroupOpenModal(true)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <CreateGroupModal
          isOpen={isCreateGroupOpenModal}
          onClose={() => setIsCreateGroupOpenModal(false)}
          onSuccess={(groupId) => {
